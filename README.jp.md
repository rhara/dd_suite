...
| `dd_draw` | `rdkit jinja2 reportlab svglib pytest` | PDF生成はWeasyPrint/cairosvgではなくreportlab+svglib（純Python）——システムのCairo/Pango/GTK依存を避けるため。詳細は`dd_draw/README.md`の「Why reportlab+svglib」参照 |
